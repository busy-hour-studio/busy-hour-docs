...
To start managing your chat messages (e.g. `create`, `update`, `delete`, etc.), you will need to use the `useChatManager` hook which is exported from the `@busy-hour/react/hooks` or `@busy-hour/react/hooks/v2` package. To use it, you just need to call it like any other hook and it will return an object. For more detail about the properties see the detail from this table:
...
To create a chat message, you can use the `createChat` function which is one of the return properties of the `useChatManager` hook. To use it, you need to pass some properties which detailed below.
...
```tsx
import { useChatManager } from '@busy-hour/react/hooks';
...
To update a chat message, you can use the `updateChat` function which is one of the return properties of the `useChatManager` hook. To use it, you need to pass some properties which detailed below.
...
To add a member to a chat message, you can use the `addMember` function which is one of the return properties of the `useChatManager` hook. To use it, you need to pass some properties which detailed below.
...
To remove a member to a chat message, you can use the `removeMember` function which is one of the return properties of the `useChatManager` hook. To use it, you need to pass some properties which detailed below.
